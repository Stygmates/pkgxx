...
pkgxx/constraint.moon:

pkgxx/constraint.moon.install: pkgxx/constraint.moon
	@echo '[01;31m  IN >    [01;37m$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/constraint.moon[00m'
	$(Q)mkdir -p '$(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx'
	$(Q)install -m0755 pkgxx/constraint.moon $(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/constraint.moon

pkgxx/constraint.moon.clean:

pkgxx/constraint.moon.uninstall:
	@echo '[01;37m  RM >    [01;37m$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/constraint.moon[00m'
	$(Q)rm -f '$(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/constraint.moon'
...
pkgxx/spec.moon.install: pkgxx/spec.moon
	@echo '[01;31m  IN >    [01;37m$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/spec.moon[00m'
	$(Q)mkdir -p '$(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx'
	$(Q)install -m0755 pkgxx/spec.moon $(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/spec.moon

pkgxx/spec.moon.clean:

pkgxx/spec.moon.uninstall:
	@echo '[01;37m  RM >    [01;37m$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/spec.moon[00m'
	$(Q)rm -f '$(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/spec.moon'
...
pkgxx/utils.moon.install: pkgxx/utils.moon
	@echo '[01;31m  IN >    [01;37m$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/utils.moon[00m'
	$(Q)mkdir -p '$(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx'
	$(Q)install -m0755 pkgxx/utils.moon $(DESTDIR)$(SHAREDIR)/lua/$(LUA_VERSION)/pkgxx/utils.moon

pkgxx/utils.moon.clean:
...
modules/arch.moon.install: modules/arch.moon
	@echo '[01;31m  IN >    [01;37m$(SHAREDIR)/pkgxx/arch.moon[00m'
	$(Q)mkdir -p '$(DESTDIR)$(SHAREDIR)/pkgxx'
	$(Q)install -m0755 modules/arch.moon $(DESTDIR)$(SHAREDIR)/pkgxx/arch.moon

modules/arch.moon.clean:

modules/arch.moon.uninstall:
	@echo '[01;37m  RM >    [01;37m$(SHAREDIR)/pkgxx/arch.moon[00m'
	$(Q)rm -f '$(DESTDIR)$(SHAREDIR)/pkgxx/arch.moon'
...
modules/test.moon.install: modules/test.moon
	@echo '[01;31m  IN >    [01;37m$(SHAREDIR)/pkgxx/test.moon[00m'
	$(Q)mkdir -p '$(DESTDIR)$(SHAREDIR)/pkgxx'
	$(Q)install -m0755 modules/test.moon $(DESTDIR)$(SHAREDIR)/pkgxx/test.moon

modules/test.moon.clean:

modules/test.moon.uninstall:
	@echo '[01;37m  RM >    [01;37m$(SHAREDIR)/pkgxx/test.moon[00m'
	$(Q)rm -f '$(DESTDIR)$(SHAREDIR)/pkgxx/test.moon'
...
$(PACKAGE)-$(VERSION).tar.gz: distdir
	...
	$(Q)tar czf $(PACKAGE)-$(VERSION).tar.gz \
		...
		$(PACKAGE)-$(VERSION)/modules/arch.moon \
